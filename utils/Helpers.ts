 ...
 * @returns {Object}
 */
 export function assignIfDefined(target: Object, source: Object): object {
 ...
 * @returns {string}
 */
export function getBaseUrl(w: Window = window): string {
 ...
 * @returns {void}
 */
export function reportError(e: Error, msg: string = ''): void {
    console.error(msg, e);
 ...
 */
export function setColorAlpha(color: string, opacity: number): string {
    if (!color) {
 ...
 */
function parseShorthandColor(color: string): Array<number> {
    let b, g, r;
 ...
 * @returns {void}
 */
export function objectSort(object: Object, callback: Function): void {
